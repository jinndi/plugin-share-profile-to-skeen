...
2. Добавьте sing-box JSON-подписку(и) в разделе **Subscriptions** (например, через [s-ui](https://github.com/admin8800/s-ui) либо [Sub-Store](https://github.com/jinndi/Sub-Store-Docker))
